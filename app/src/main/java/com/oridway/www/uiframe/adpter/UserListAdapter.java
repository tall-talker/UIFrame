...
public class UserListAdapter extends BaseAdapter {
    ...
    private UserNormalListCallBack mUserNormalListCallBack;
    private LayoutInflater mInflater;

    public interface UserNormalListCallBack {
        void onClick(View v);
    }

    public UserListAdapter(List<ClsNormalUser> list, Context mContext) {
        mList = list;
